...
deltasToPlot = {}
deltasToPlot["Nominal (FD)"] = ["/home/cvilela/CAFAna/lblpwgtools/code/CAFAna/CAFAna/build/Linux/scripts/delta_zero_excl_nominal_FD.root",
#                                "/home/cvilela/CAFAna/lblpwgtools/code/CAFAna/CAFAna/build/Linux/scripts/delta_delta_nominal_NDFD.root"]
                                "/home/cvilela/CAFAna/lblpwgtools/code/CAFAna/CAFAna/build/Linux/scripts/delta_excl_nominal_FD.root"]
deltasToPlot["NuWroReweight (FD)"] = ["/home/cvilela/CAFAna/lblpwgtools/code/CAFAna/CAFAna/build/Linux/scripts/delta_zero_excl_NuWro_FD.root",
                                      "/home/cvilela/CAFAna/lblpwgtools/code/CAFAna/CAFAna/build/Linux/scripts/delta_delta_NuWro_FD.root"]
deltasToPlot["MissingProtonEnergy (FD)"] = ["/home/cvilela/CAFAna/lblpwgtools/code/CAFAna/CAFAna/build/Linux/scripts/delta_zero_excl_MissingProton_FD.root",
...
plt.ylabel(r"$\sqrt{\chi^{2} (\delta = 0) - \chi^2 (\delta_{best fit})}$")
plt.legend(loc = "upper right")
plt.savefig("delta_zero_excl_vsdelta.png")
plt.savefig("delta_zero_excl_vsdelta.pdf")
plt.show()
